   ...
   function escapeHtml(unsafe) {
    ...
    function connectSocket() {
        ...
        socket.on('user found', (user) => {
            ...
            // Ensure startChat is called with the correct user object
            if (user && user.id) {
                startChat(user);
            ...
            // Reload conversations sidebar to include the new conversation (if it wasn't already there)
            loadConversationsSidebar();
        });
    ...
    function renderConversationsSidebar(conversations) {
        ...
        conversations.forEach(user => {
            ...
            li.dataset.userid = user.id;
            li.onclick = () => startChat(user); // Use startChat
